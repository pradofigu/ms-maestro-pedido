...
public class TestingServiceScope 
{
    ...
    public async Task<TEntity> FindAsync<TEntity>(params object[] keyValues)
        where TEntity : class
    {
        var context = _scope.ServiceProvider.GetService<OrderDbContext>();
    ...
    {
        var dbContext = _scope.ServiceProvider.GetRequiredService<OrderDbContext>();
    ...
    public Task<T> ExecuteDbContextAsync<T>(Func<OrderDbContext, Task<T>> action)
