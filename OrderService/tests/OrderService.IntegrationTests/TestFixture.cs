...
using OrderService.Extensions.Services;
using OrderService.Databases;
using OrderService.Resources;
using OrderService.SharedTestHelpers.Utilities;
...
public class TestFixture : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        builder.Configuration.GetSection(ConnectionStringOptions.SectionName)[ConnectionStringOptions.OrderServiceKey] = _dbContainer.GetConnectionString();
    ...
    private static async Task RunMigration(string connectionString)
    {
        var options = new DbContextOptionsBuilder<OrderDbContext>()
            ...
            .Options;
        var context = new OrderDbContext(options, null, null, null);
